...
<div class="container">
        ...
        <div class="option-container">
            ...
            <div class="option">
             ...
             <div class="option">
                <a href=""><img src="{{asset('image/img/caminhao.png')}}" alt="Caminhão"></a>
                <span>Caminhão</span>
            </div>
            <div class="option">
                <a href=""><img src="{{asset('image/img/semi-reboque.png')}}" alt="Semi-reboque"></a>
                <span>Semi-reboque</span>
            </div>
            <div class="option">
                <a href=""><img src="{{asset('image/img/outros.png')}}" alt="Outros"></a>
                <span>Outros</span>
            </div>
        </div>
    </div>
