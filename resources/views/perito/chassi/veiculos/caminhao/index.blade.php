...
.form-group1 input {
  ...
  width: calc(100% - 160px);
    ...
    <header>
        <h1>Exame de Inspeção Veicular</h1>
    </header>
    <br>
    ...
    <form id="form"  method="POST">
        ...
        <input type="text" name="veiculo_id" value="caminhao" hidden>        
        <div class="form-group">
            <label for="tipo-caminhao">Tipo de caminhão:</label>
            <select id="tipo-caminhao" name="tipo_caminhao" required>
              <option>Selecione</option>      
              <option>Caminhão simples</option>
              <option>Caminhão articulado</option>
              <option>Caminhão reboque</option>
            </select>
          </div>
        <div class="form-group">
        ...
        <div class="form-group1">
            <label for="capacidade-carga">Capacidade:</label>
            <input type="text" id="capacidade-carga" name="capacidade_carga" placeholder="Digite a capacidade de carga" required>
          </div>
          <div class="form-group1">
            <label for="numero-eixos">Número de eixos:</label>
            <input type="text" id="numero-eixos" name="numero_eixos" placeholder="Digite o número de eixos" required>
          </div>
